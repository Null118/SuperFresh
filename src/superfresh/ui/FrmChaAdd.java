...
public class FrmChaAdd extends JDialog implements ActionListener {
	...
	public FrmChaAdd(FrmMain frmMain, String s, boolean b) {
		super(frmMain, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel)
			...
			try {
				a.ChaAdd(AddressManager.curAddress, shi, sheng, qu, juti, name, tel);
				this.setVisible(false);
