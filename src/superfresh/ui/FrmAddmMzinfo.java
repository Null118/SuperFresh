...
public class FrmAddmMzinfo extends JDialog implements ActionListener {
		...
		public FrmAddmMzinfo(FrmMain frmMain, String s, boolean b) {
			super(frmMain, s, b);
