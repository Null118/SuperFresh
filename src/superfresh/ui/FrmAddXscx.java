...
public class FrmAddXscx extends JDialog implements ActionListener {
	...
	public FrmAddXscx(FrmMain frmMain, String s, boolean b) {
		super(frmMain, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel)
			...
			try {
				a.AddXscx(com_id, price, count, start_day, end_day);
				this.setVisible(false);
